...
import RectangleBlockImage from "../../images/PaverBlocks/rectangle8x9.jpg";
  ...
  const data = useStaticQuery(graphql`
    query {
      allFile(
        filter: {
          extension: { regex: "/(jpg)/" }
          relativeDirectory: { eq: "Products/Rectangle8x9" }
        }
      ) {
        edges {
          node {
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  <p className="mb-3 text-[#787878] text-base text-center leading-6">
                    ...
                    driveways, pathways, and patios. Their durable structure
                    and smooth surface make them a popular choice for creating
