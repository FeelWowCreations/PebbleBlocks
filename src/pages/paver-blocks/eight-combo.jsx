              ...
              <div className="flex flex-col items-center">
                ...
                >
                  <p className="mb-3 text-[#787878] text-base text-center leading-6">
                    ...
                    stylish and highly durable solution for outdoor surfaces. The
                    EightInch pattern is ideal for creating stable and visually
                    appealing walkways, driveways, and patios, with the added
                    benefit of interlocking strength to support heavy loads in areas
                    like parking lots. Our pavers are crafted with top-quality materials,
                    ensuring both aesthetics and functionality. Popular for their unique
                    style and high durability, our clients trust our EightInch pavers to
                    withstand daily use in demanding environments. Manufactured in
                    Coimbatore, these blocks are designed for versatility and long-lasting
                    quality.
                  </p>
                </motion.div>
              </div>
