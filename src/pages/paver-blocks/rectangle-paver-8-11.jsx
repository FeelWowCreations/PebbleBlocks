              ...
              <div className="flex flex-col items-center">
                <div className="grid grid-cols-1 md:grid-cols-[repeat(2,50%)] mb-[30px] w-full h-full">
                  <div className="w-[300px] h-[280px] md:w-[350px] md:h-[350px] col-span-1 self-center justify-self-center rounded-lg">
                    <img
                      src={Rectangle8x11Image}
                      alt="Rectangle 8x11 Block"
                  ...
                  <div className="ml-0 md:ml-10">
                    <form className="space-y-4" onSubmit={sendEmail}>
                      ...
                      <input
                        ...
                        name="product"
                        value={form.product}
                        placeholder="Rectangle 8x11 paver"
                        className="w-full border border-gray-300 rounded-md p-2"
                        readOnly
                      />
                      <button
                ...
                >
                  ...
                  The 8x11 rectangle paver block is a versatile solution, offering a classic design suitable for both residential and commercial applications. Its balanced dimensions and sturdy construction ensure reliable performance in areas like home, office, shops and other commercial areas. With a focus on durability and timeless appeal, this paver block is the perfect choice for creating functional and visually appealing outdoor environments.
                  </p>
                </motion.div>
              </div>
            </div>
...
export default Rectangle8x11Block;
