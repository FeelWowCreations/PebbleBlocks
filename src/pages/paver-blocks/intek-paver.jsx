            ...
            <div className="shadow-12 p-[30px] lg:py-10 lg:px-[140px] relative bg-white rounded-xl">
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  The Intek Paver Block is a classic traditional design that has stood the test of time, remaining a popular choice for over two decades. Known for its elegance and durability, this design is widely used in temples and homes, adding a touch of heritage and charm to any space. Perfect for pathways, courtyards, and other areas, the Intek block combines a proven aesthetic with reliable performance, making it a timeless addition to both modern and traditional settings.
                  </p>
                </motion.div>
              </div>
            </div>
